...
public class WireCrossing {
    public static void main(String[] args) {
        ArrayList<String> wireADirections = FileLoader.loadSingleLineCommaStringFile("inputfiles/day03.dat", 1);
        ArrayList<String> wireBDirections = FileLoader.loadSingleLineCommaStringFile("inputfiles/day03.dat", 2);
